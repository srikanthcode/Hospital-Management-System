...
<head>
    ...
    <title>Dr. Priya Sharma - Lotus Women's Hospital</title>
    ...
    <div class="container">
        ...
        <div class="row align-items-center g-5">
            ...
            <div class="col-md-7">
                ...
                <p class="mt-3">
                    Dr. Priya Sharma is a dedicated healthcare professional
                    providing compassionate and personalized care for women.
                </p>
                ...
                <div class="doctor-info mt-4">
                    ...
                    <p>
                        ...
                        Obstetrics, Gynaecology &amp; Women's Healthcare
                    </p>
...
<section class="py-5">
    ...
    <div class="container">
        ...
        <div class="doctor-about-box">
            ...
            <p>
                Dr. Priya Sharma is an experienced obstetrician and
                gynaecologist at Lotus Women's Hospital. She is committed
                to providing quality healthcare in a comfortable and
                supportive environment.
            </p>

            <p>
                She provides care related to pregnancy, maternity,
                gynaecological health, and women's wellness. Her approach
                focuses on understanding each patient's needs and providing
                appropriate medical guidance.
            </p>

            <p>
                She works closely with the hospital's healthcare team to
                provide safe and personalized care to patients.
            </p>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <div class="service-box p-4 text-center h-100">
                    ...
                    <p>
                        Regular monitoring and personalized care
            ...
            <div class="col-md-4">
                ...
                <div class="service-box p-4 text-center h-100">
                    ...
                    <p>
                        Comprehensive healthcare for women's
                        gynaecological needs.
                    </p>
            ...
            <div class="col-md-4">
                ...
                <div class="service-box p-4 text-center h-100">
                    ...
                    <h5>Gynaecological Care</h5>

                    <p>
                        Diagnosis, consultation and treatment for
